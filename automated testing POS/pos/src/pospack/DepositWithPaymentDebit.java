...
public class DepositWithPaymentDebit {
	WebDriverWait wait;
	public static WebDriver driver;
		...
		public static void DetailMenginap() throws InterruptedException {
				...
				driver.findElement(By.cssSelector("[class='613']")).click();
		...
		public static void Deposit() throws InterruptedException{
			//deposit transfer bank
			driver.findElement(By.cssSelector(".button_book.bblue")).click();
			driver.findElement(By.id("deposit-folio")).click();
			//class harus di ubah, angka terakhir/satuannya sebelum di jalankan
			driver.findElement(By.cssSelector("[class='20712']")).click();
			driver.findElement(By.id("type")).click();
			driver.findElement(By.cssSelector("[class='12']")).click();
			driver.findElement(By.xpath("//*[@id=\"bankname\"]")).click();
			driver.findElement(By.cssSelector("[class='009']")).click();
			driver.findElement(By.id("debit-card-number")).sendKeys("122933887333");
			driver.findElement(By.id("nominal")).sendKeys("120000");
			driver.findElement(By.id("debit-ref-number")).sendKeys("123344212");
			driver.findElement(By.cssSelector("row-detail")).sendKeys("ndak ada lagi");
