...
public class LoginUntilHapusBooking {
	WebDriverWait wait;
	...
	public static WebDriver driver;
		...
		public static void DetailMenginap() throws InterruptedException {
				...
				JavascriptExecutor js = (JavascriptExecutor)driver;
				 ...
				 driver.findElement(By.xpath("//input[@type='text'][@placeholder='Nama Depan']")).sendKeys("dono");
				 driver.findElement(By.xpath("//input[@type='text'][@placeholder='Nama Belakang']")).sendKeys("kasino");
		...
		public static void Konfirmasi() throws InterruptedException {	   
			driver.findElement(By.xpath("//*[@id=\"info-book\"]/div[3]/div/button[2]")).click(); 
