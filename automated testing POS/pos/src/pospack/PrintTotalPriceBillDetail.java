...
public class PrintTotalPriceBillDetail {
	WebDriverWait wait;
	public static WebDriver driver;
		...
		public static void Print() throws InterruptedException{
			driver.findElement(By.xpath("//*[@id=\"info-book\"]/div[2]/div[2]/div[1]/div[1]/span[2]/div")).click();
			WebElement oCheckBox = driver.findElement(By.cssSelector("input[value='total']"));
			 oCheckBox.click();
			 WebElement aCheckBox = driver.findElement(By.cssSelector("input[value='detail']"));
			 aCheckBox.click();
			driver.findElement(By.xpath("//*[@id=\"info-book\"]/div[2]/section/div[2]/div/div[2]/button[2]")).click();
		} 
}
