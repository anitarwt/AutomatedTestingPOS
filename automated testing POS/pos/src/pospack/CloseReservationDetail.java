...
public class CloseReservationDetail {
	WebDriverWait wait;
	public static WebDriver driver;
		...
		public static void CloseReservasi() throws InterruptedException{
			driver.findElement(By.cssSelector(".cancel-book.fleft")).click();
