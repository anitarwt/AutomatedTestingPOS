...
public class LoginUntilReserveWithInvalidData {
	...
	public static WebDriver driver;
		...
		public static void DetailMenginap() throws InterruptedException {
				...
				JavascriptExecutor js = (JavascriptExecutor)driver;
				 ...
				 driver.findElement(By.xpath("//input[@type='text'][@placeholder='Nama Depan']")).sendKeys(" ");
				...
				driver.findElement(By.xpath("//*[@id=\"phone\"]")).sendKeys("02398");
