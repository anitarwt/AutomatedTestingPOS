...
public class DepositWithPaymentTransferBank {
	...
	public static WebDriver driver;
		...
		public static void Deposit() throws InterruptedException{
			...
			driver.findElement(By.cssSelector("[class='20697']")).click();
			driver.findElement(By.id("type")).click();
			driver.findElement(By.cssSelector("[class='13']")).click();
			driver.findElement(By.id("bankname")).click();
			driver.findElement(By.cssSelector("[class='009']")).click();
			driver.findElement(By.id("bank-ref-number")).sendKeys("12293");
