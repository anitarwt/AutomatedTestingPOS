...
public class DepositWithPaymentCreditCard {
	WebDriverWait wait;
	public static WebDriver driver;
		...
		public static void Deposit() throws InterruptedException{
			...
			driver.findElement(By.cssSelector("[class='20669']")).click();//nilai id  folio harus di update sebelum di jalankan
			driver.findElement(By.id("type")).click();
			driver.findElement(By.cssSelector("[class='11']")).click();
			driver.findElement(By.id("cc-name")).sendKeys("valeria");
			driver.findElement(By.id("nominal")).sendKeys("120000");
			driver.findElement(By.id("cc-card-number")).sendKeys("4111111111111111");
			driver.findElement(By.id("cc-ref-number")).sendKeys("123344212");
			driver.findElement(By.xpath("//*[@id=\"info-book\"]/section/div[2]/div/div[2]/div[11]/span[2]/textarea")).sendKeys("ndak ada lagi");
